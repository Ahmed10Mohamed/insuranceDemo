...
(function () {
  ...
  const flatpickrDate = document.querySelector('#flatpickr-date'),
    ...
    flatpickrDateTimeOrder = document.querySelector('#flatpickr-datetime-order'),
    ...
    flatpickrStartOrder = document.querySelector('#flatpickr-startOrder'),
    flatpickrEndtOrder = document.querySelector('#flatpickr-endOrder'),
  ...
  if (flatpickrDateTime) {
    ...
    // Datetime
  if (flatpickrDateTimeOrder) {
    flatpickrDateTimeOrder.flatpickr({
      enableTime: true,
      dateFormat: 'Y-m-d H:i',
      static: true
    });
  ...
  if (flatpickrStartOrder) {
    flatpickrStartOrder.flatpickr({
      enableTime: true,
      dateFormat: 'Y-m-d H:i',
      static: true
    });
  }
  if (flatpickrEndtOrder) {
    flatpickrEndtOrder.flatpickr({
      enableTime: true,
      dateFormat: 'Y-m-d H:i',
      static: true
    });
