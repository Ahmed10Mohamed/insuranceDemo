...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y" style="animation: fadeInUp 0.5s ease-out both;">
        <div class="app-ecommerce nq-company-form">
            ...
            <form method="POST" id="addForm" action="{{ route('Company.store') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-12">
                        ...
                        <div class="card mb-6">
                            <h5 class="card-header page_title">اضافة شركه</h5>
                            <div class="card-body">
                                ...
                                <div class="row mb-5 gx-5">
                                    <div class="col-12 col-lg-10">
                                        ...
                                        <div class="mb-4 row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" required name="commercialNumber"
                                                    value="{{ old('commercialNumber') }}" id="commercialNumber">
                                            </div>
                                        </div>
                                        <!-- city -->
                                        <div class="mb-4 row">
                                        ...
                                        <div class="mb-4 row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <select id="companyType-org" name="companyType" class="select2 form-select"
                                                    ...
                                                    <option value="company" @selected(old('companyType') == 'company')>شركة</option>
                                                    <option value="ELNaql" @selected(old('companyType') == 'ELNaql')>الناقل</option>
                                        ...
                                        <!-- companyName -->
                                        <div class="mb-4 row">
                                            <label for="companyName" class="col-md-3 col-form-label">اسم الشركه <span class="text-danger">*</span></label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="mb-4 row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" required name="phonePerson"
                                                    value="{{ old('phonePerson') }}" id="phonePerson">
                                            </div>
                                        </div>
                                        <!-- emailPerson -->
                                        <div class="mb-4 row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control"  name="emailPerson"
                                                    value="{{ old('emailPerson') }}" id="emailPerson">
                                            </div>
                                        </div>
                                        <!-- userName -->
                                        <div class="mb-4 row">
                                            <label for="userName" class="col-md-3 col-form-label">اسم المستخدم <span class="text-danger">*</span></label>
                                            <div class="col-md-9">
                                                ...
                                                <select id="company_specialization_id" name="company_specialization_id"
                                                    ...
                                                    @foreach ($companySpecializations as $companySpecialization)
                                                        <option value="{{ $companySpecialization->id }}"
                                                            @selected(old('company_specialization_id') == $companySpecialization->id)>{{ $companySpecialization->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                        ...
                        <div class="mt-2">
                            <button type="submit" id="submitBtn" class="btn btn-primary">
                                ...
                                <span class="btn-text">اضافة شركة</span>
                            </button>
