          ...
          <nav
            ...
            <div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-md-auto">
                ...
                <!-- Notification -->
                <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-2" style="display:none">
                  <a
                    class="nav-link dropdown-toggle hide-arrow btn btn-icon btn-text-secondary rounded-pill"
                    href="javascript:void(0);"
                    data-bs-toggle="dropdown"
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item mt-0" href="{{route('Profile')}}">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="flex-grow-1">
                            ...
                            <small class="text-body-secondary">{{optional(admin()->userType)->name}}</small>
                          </div>
                        </div>
                      </a>
                    </li>
                    ...
                    <li>
                      <div class="d-grid px-2 pt-2 pb-1">
                        <a class="btn btn-sm btn-danger d-flex" href="{{route('admin_logout')}}" >
