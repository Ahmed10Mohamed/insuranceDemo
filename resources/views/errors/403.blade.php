...
<head>
  ...
  <title>غير مصرح لك - لوحة التحكم</title>
...
<body>
  ...
  <div class="container-xxl container-p-y">
    <div class="misc-wrapper text-center">
      <h1 class="mb-2 mx-2" style="line-height: 6rem; font-size: 6rem">٤٠١</h1>
      <h4 class="mb-2 mx-2">غير مصرح لك! 🔐</h4>
      <p class="mb-6 mx-2">ليس لديك الصلاحية للوصول إلى هذه الصفحة. عُد إلى الصفحة الرئيسية!</p>
      <a @if(admin()) href="{{ route('Admin-Dashboard')}}" @else href="{{ url('/')}}" @endif  class="btn btn-primary mb-10">العودة إلى الرئيسية</a>
      <div class="mt-12">
        <img src="{{asset('adminFiles/img/illustrations/page-misc-you-are-not-authorized.png')}}" alt="غير مصرح" width="170" class="img-fluid" />
      </div>
    </div>
  </div>
