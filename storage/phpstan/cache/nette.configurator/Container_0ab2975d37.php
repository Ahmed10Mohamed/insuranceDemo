...
class Container_0ab2975d37 extends _PHPStan_37ef388af\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0445(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_0ab2975d37 $container)
			{
	...
	public function createServiceContainer(): Container_0ab2975d37
	{
		return $this;
	}
