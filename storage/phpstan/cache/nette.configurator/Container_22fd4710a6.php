...
class Container_22fd4710a6 extends _PHPStan_2526f5004\Nette\DI\Container
{
	protected $tags = [
		'phpstan.rules.rule' => [
			'029' => true,
	...
	public function createService0445(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_22fd4710a6 $container)
			{
	...
	public function createServiceContainer(): Container_22fd4710a6
	{
		return $this;
	}
