...
class Container_d28a63f54d extends _PHPStan_2526f5004\Nette\DI\Container
{
	protected $tags = [
		'phpstan.rules.rule' => [
			'029' => true,
	...
	public function createService026(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			...
			['analyseAndScan' => ['*/storage/*', '*/vendor/*', '*/bootstrap/cache/*'], 'analyse' => []]
		);
	}
	...
	public function createService0146(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			$this->getService('024'),
			['#Access to an undefined property App\\\Http\\\Resources\\\.*::\$[a-z_]+#'],
			true
		);
	}
	...
	public function createService0445(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_d28a63f54d $container)
			{
	...
	public function createServiceContainer(): Container_d28a63f54d
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'excludePaths' => ['analyseAndScan' => ['*/storage/*', '*/vendor/*', '*/bootstrap/cache/*'], 'analyse' => []],
			'level' => 7,
			'paths' => [
				'E:\mywork\laragon\www\MohammedSA\naqliyahtak\app',
			...
			'ignoreErrors' => ['#Access to an undefined property App\\\Http\\\Resources\\\.*::\$[a-z_]+#'],
